...
const ubx_cfg_item_t CFG_MSGOUT_UBX_RXM_SFRBX_USB =
{"CFG_MSGOUT_UBX_RXM_SFRBX_USB", 0x20910234, U1, 0, NA};
...
ubx_cfg_item_map_t ubxKeyCfgItemMap = {
  ...
  {CFG_MSGOUT_UBX_RXM_SFRBX_USB.ubx_key_id, CFG_MSGOUT_UBX_RXM_SFRBX_USB},
